...
export const metadata: Metadata = {
  ...
  twitter: {
    ...
    title: "Nirajan Dhungel | Full Stack Developer",
    description:
      "Web developer sharing projects and blogs on React, Next.js, and AI.",
...
export default function RootLayout({
  ...
  return (
    <html lang="en" suppressHydrationWarning>
      ...
      <body
        className={`bg-[#E9F5E9] transition-colors dark:bg-[#050D05] dark:text-white ${geistSans.variable} ${geistMono.variable}`}
      >
        <ThemeProvider>
          <Navbar />
